...
namespace DoctrineORMModule\Proxy\__CG__\Service\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Category extends \Service\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'services', 'id', 'createdAt', 'updatedAt');
        }
     ...
     * {@inheritDoc}
     */
    public function addService(\Service\Entity\Service $service)
    {
     ...
     * {@inheritDoc}
     */
    public function removeService(\Service\Entity\Service $service)
    {
